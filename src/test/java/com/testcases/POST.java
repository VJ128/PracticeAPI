...
public class POST extends BaseClass {
	...
	public void post() throws ClientProtocolException, IOException {
		...
		user = new PojoSingleUser("Vijaya", "Project Manager");
		//Java to Json string
	...
	// --------------------------data validation------------------------------
	@Test
	public void dataValidation() throws JsonMappingException, JsonProcessingException {
		Object name1 = jsonresp.get("name");
		String name2 = user.getName();
		Assert.assertEquals(name1, name2);

		Object job1 = jsonresp.get("job");
		String job2 = user.getJob();
		Assert.assertEquals(job1, job2);

		// Another way of validating data
		//json to java object
		PojoSingleUser userresp=mapper.readValue(response, PojoSingleUser.class);
